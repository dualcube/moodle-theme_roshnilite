 ...
 */
if (!empty($PAGE->theme->setting_file_url('aboutsiteimage1', 'aboutsiteimage1'))) {
...
if (!empty($PAGE->theme->setting_file_url('aboutsiteimage2', 'aboutsiteimage2'))) {
...
if (!empty($PAGE->theme->setting_file_url('aboutsiteimage3', 'aboutsiteimage3'))) {
...
if (!empty($PAGE->theme->setting_file_url('aboutsiteimage4', 'aboutsiteimage4'))) {
